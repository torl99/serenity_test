            ...
            <div className="p-grid">
                <div className="p-col-6 p-md-8 filter-container">
                    <div style={{textAlign:'left'}}>
                        <InputText placeholder="Search by brand" style={{width:'auto'}} onKeyUp={e => this.dv.filter(e.target.value)} />
                    </div>
                </div>
                    ...
                    <div className="p-col-12">
                        <div className="p-messages p-component p-messages-success" style={{margin: '0 0 1em 0', display: 'block'}}>
                            <div className="p-messages-wrapper">
                                <ul>
                                    <li>
                                        <span className="p-messages-icon pi-md-check"></span>
                                        <span className="p-messages-detail">Serenity provides a theme for all 70+ PrimeReact Components. This page contains samples of the commonly used components for demo purposes.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="card card-w-title">
                            ...
                            <div className="p-grid">
                                ...
                                <div className="p-col-12 p-md-4">
                                    <Button label="Login" icon="pi-md-launch" onClick={() => this.setState({dialogVisible:true})} />
                                </div>
                            </div>
