...
export class MenusDemo extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            home: {
                icon: 'pi-md-home', url: 'https://www.primefaces.org/primereact'
            },
            stepsItems: [
                {
                    label: 'Personal'
            ...
            tieredItems: [
                ...
                {
                    label: 'Quit', icon: 'pi-md-power-settings-new'
                }
            ],
            items: [
                {
            ...
            megaMenuItems: [
                ...
                {
                    label: 'Entertainment', icon: 'pi-md-stars',
                    items: [
                        [
                            {
                ...
                {
                    label: 'Technology', icon: 'pi-md-phone-android',
                    items: [
                        [
                            {
                                label: 'Technology 1',
            ...
            <div className="p-grid p-fluid">
                ...
                <div className="p-col-12 p-lg-6">
                    <div className="card card-w-title">
                        ...
                        <Button icon="pi-md-launch" label="Show" onClick={(event)=>this.menu.toggle(event)} style={{marginTop:'20px', width:'auto'}} />
                    </div>
