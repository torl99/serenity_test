        ...
        return (
            <div className="p-grid p-fluid">
                <div className="p-col-12 p-lg-6">
                    ...
                    <div className="card card-w-title">
                        <h1>MultiSelect</h1>
                        <MultiSelect value={this.state.cars} options={this.state.carOptions} onChange={event => this.setState({cars: event.value})} placeholder="Choose" filter={true}/>
                    </div>
                ...
                <div className="p-col-12">
                    <div className="card card-w-title">
                        ...
                        <div className="p-grid">
                            ...
                            <div className="p-col-12 p-md-6">
                                <div className="p-inputgroup">
                                    <span className="p-inputgroup-addon"><i className="material-icons">credit_card</i></span>
                                    <span className="p-inputgroup-addon"><i className="material-icons">card_travel</i></span>
                            ...
                            <div className="card card-w-title">
                                ...
                                <div className="p-grid">
                                    <div className="p-col-12 p-md-6" style={{textAlign:'center'}}>
                                        ...
                                        <Button label="Secondary" style={{ marginBottom: 10 }} className="p-button-secondary" />
                                        <Button label="Green / Success" style={{ marginBottom: 10 }} className="p-button-success" />
                                        <Button label="Blue /Info" style={{ marginBottom: 10 }} className="p-button-info" />
                                        <Button label="Amber / Warning" style={{ marginBottom: 10 }} className="p-button-warning" />
                                        <Button label="Red / Danger" style={{ marginBottom: 10 }} className="p-button-danger" />
                                    ...
                                    <div className="p-col-12 p-md-6" style={{textAlign:'center'}}>
                                        ...
                                        <Button label="Secondary" style={{ marginBottom: 10 }} className="p-button-secondary flat-btn" />
                                        <Button label="Green / Success" style={{ marginBottom: 10 }} className="p-button-success flat-btn" />
                                        <Button label="Blue /Info" style={{ marginBottom: 10 }} className="p-button-info flat-btn" />
                                        <Button label="Amber / Warning" style={{ marginBottom: 10 }} className="p-button-warning flat-btn" />
                                        <Button label="Red / Danger" style={{ marginBottom: 10 }} className="p-button-danger flat-btn" />
                                        <Button label="Blue-Grey Button" style={{ marginBottom: 10 }} className="blue-grey-btn flat-btn" />
